...
namespace FrasquitoGames.Utils
{
    ...
    public class UITextComplex
    {
        ...
        public UITextComplex(Transform parent, Vector2 anchoredPosition, int fontSize, char iconChar, string text, Icon[] iconArr, Font font)
        {
