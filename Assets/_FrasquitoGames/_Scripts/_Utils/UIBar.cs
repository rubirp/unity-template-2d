...
namespace FrasquitoGames.Utils
{
    ...
    public class UIBar
    {
        ...
        public UIBar(Transform parent, Vector2 anchoredPosition, Vector2 size, Color barColor, float sizeRatio)
        {
            SetupParent(parent, anchoredPosition, size);
            SetupBar(barColor);
            SetSize(sizeRatio);
        }
        public UIBar(Transform parent, Vector2 anchoredPosition, Vector2 size, Color barColor, float sizeRatio, Outline outline)
        {
            SetupParent(parent, anchoredPosition, size);
        ...
        public UIBar(Transform parent, Vector2 anchoredPosition, Vector2 size, Color backgroundColor, Color barColor, float sizeRatio)
        {
            SetupParent(parent, anchoredPosition, size);
        ...
        public UIBar(Transform parent, Vector2 anchoredPosition, Vector2 size, Color backgroundColor, Color barColor, float sizeRatio, Outline outline)
        {
            SetupParent(parent, anchoredPosition, size);
            if(outline != null) SetupOutline(outline, size);
            SetupBackground(backgroundColor);
