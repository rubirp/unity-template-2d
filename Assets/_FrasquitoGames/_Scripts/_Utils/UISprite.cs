...
namespace FrasquitoGames.Utils
{
    ...
    public class UISprite
    {
        ...
        {
            UISprite uiSprite = new UISprite(GetCanvasTransform(), Assets.i.s_White, anchoredPosition, size, color);
        ...
        public static UISprite CreateDebugButton(Vector2 anchoredPosition, string text, Action ClickFunc, Color color, Vector2 padding)
        {
            UITextComplex uiTextComplex;
            UISprite uiSprite = CreateDebugButton(anchoredPosition, Vector2.zero, ClickFunc, color, text, out uiTextComplex);
        ...
        public static UISprite CreateDebugButton(Vector2 anchoredPosition, Vector2 size, Action ClickFunc, Color color, string text, out UITextComplex uiTextComplex)
        {
            ...
            uiTextComplex = new UITextComplex(uiSprite.gameObject.transform, Vector2.zero, 12, '#', text, null, null);
